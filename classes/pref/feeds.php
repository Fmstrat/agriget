...
#			</div>";
		...
		print "<h3>" . __("Using OPML you can export and import your feeds, filters, labels and Agriget settings.") . "</h3>";
		...
		print "<p>" . __('Your OPML can be published publicly and can be subscribed by anyone who knows the URL below.') .
			" " .
			__("Published OPML does not include your Agriget settings, feeds that require authentication or feeds hidden from Popular feeds.") . "</p>";
